...
- [x] 设屋里共有𝑘人， $𝑏𝑖表示第𝑖人的生日(1 ≤ 𝑖 ≤ 𝑘, 1 ≤ 𝑏𝑖 ≤ 𝑛 )且生日均匀分布在一年的
𝑛天中，则生日落在𝑟天的概率是：Pr 𝑏𝑖 = 𝑟 = 1/𝑛。两个人𝑖和𝑗的生日都落在同一天𝑟上的概率是：
Pr 𝑏𝑖 = 𝑟且𝑏𝑗 = 𝑟 = Pr 𝑏𝑖 = 𝑟 Pr 𝑏𝑗 = 𝑟 = 1/𝑛
2
两人生日落在同一天的概率是：
Pr 𝑏𝑖 = 𝑏𝑗 = ෍
𝑟
...
2
= 1/𝑛
对屋子里𝑘个人中的每一对(𝑖,𝑗)，其中1 ≤ 𝑖 < 𝑗 ≤ 𝑘，定义指示器随机变量𝑋𝑖𝑗如下：
𝑋𝑖𝑗 = 𝐼 𝑖和𝑗生日相同 = ቊ
1 如果𝑖和𝑗生日相同
0 其他
根据引理5.1，我们有：
𝐸 𝑋𝑖𝑗 = Pr 𝑖和𝑗生日相同 = 1/�：设𝑋表示生日相同的两人对之和的随机变量，我们有
𝑋 = ෍
𝑖=1
𝑘
෍
...
𝑘 𝑘 − 1
2𝑛
当𝑘 𝑘 − 1 ≥ 2𝑛时，生日相同的两人对的期望至少是1。
对于𝑛 = 365，若𝑘 = 28人同处一屋，则可以期望至少有2个人生日相同。
